    ...
    head: () => ({
      meta: [
        ...
        { title: "apiguard" },
        {
          name: "description",
          content:
            "API Gurad is an API security and testing platform that automates vulnerability detection and performance analysis.",
        },
        ...
        },
        {
          property: "og:image",
          content:
            "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/23fe50d5-f682-4ed6-a0a3-61d53413efd4/id-preview-207bc44e--bc296c8a-1de7-4f15-ad21-c9b743b7127a.lovable.app-1780769366032.png",
        },
        {
          name: "twitter:image",
          content:
